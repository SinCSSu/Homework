...
QT_MOC_LITERAL(1, 7, 10), // "click_back"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "succeed"
QT_MOC_LITERAL(4, 27, 2) // "id"

    },
    "Signin\0click_back\0\0succeed\0id"
};
...
void Signin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->succeed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signin::click_back)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signin::succeed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Signin::click_back()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Signin::succeed(QString _t1)
{
